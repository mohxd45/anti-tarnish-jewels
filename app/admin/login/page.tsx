  ...
  return (
    <div className="relative min-h-screen grid place-items-center px-4 py-10">
      <div className="relative z-10 w-full max-w-md animate-in fade-in slide-in-from-bottom-8 duration-700">
        <div className="p-8 sm:p-10 rounded-[2rem] border border-adminBorder bg-adminCard shadow-2xl">
          <div className="flex flex-col items-center text-center">
            <div className="h-16 w-16 rounded-2xl grid place-items-center text-adminSidebar shadow-lg mb-6 bg-adminGold">
              <Gem className="h-8 w-8" />
            </div>
            <h1 className="font-serif text-3xl font-semibold tracking-tight text-adminSidebar">LONA JEWELS</h1>
            <p className="text-[11px] uppercase tracking-[0.25em] font-semibold text-adminGold mt-2">Admin Console</p>
          </div>
          ...
          {(!hasFirebaseConfig && isDevLocal) ? (
            <div className="mt-8 space-y-5 animate-in fade-in zoom-in-95 duration-500">
              ...
              <button
                ...
                className="w-full h-12 rounded-xl text-white font-medium hover:opacity-90 transition-all flex items-center justify-center gap-2 bg-adminGold"
              >
            ...
            <form onSubmit={submit} className="mt-8 space-y-5">
              <div className="space-y-1.5">
                <Label htmlFor="email" className="text-xs uppercase tracking-wider text-adminMuted font-semibold">Admin Email *</Label>
                <div className="relative">
                  <Mail className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-adminMuted" />
                  <Input 
                    id="email" 
                    type="email" 
                    required
                    ...
                    className="pl-10 bg-white h-12 rounded-xl border-adminBorder focus-visible:ring-adminGold text-adminSidebar" 
                  />
                </div>
              </div>

              <div className="space-y-1.5">
                <Label htmlFor="pwd" className="text-xs uppercase tracking-wider text-adminMuted font-semibold">Password *</Label>
                <div className="relative">
                  <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-adminMuted" />
                  <Input 
                    id="pwd" 
                    type="password" 
                    required
              ...
              <LoadingButton 
                ...
                className="w-full h-12 rounded-xl text-white font-medium hover:opacity-90 transition-all mt-6 shadow-md bg-adminGold hover:bg-adminGold/90"
              >
          ...
          <p className="text-center text-[11px] font-medium text-adminMuted mt-8 uppercase tracking-widest">
