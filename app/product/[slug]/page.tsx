...
export default function ProductDetailsPage() {
  ...
  useEffect(() => {
    async function loadData() {
      ...
      try {
        ...
        if (found) {
          setProduct(found);
          const similarList = await getSimilarProducts(found.category, found.id, 4);
  ...
  if (loading) {
    return (
      <div className="mx-auto max-w-7xl px-4 py-8 md:py-12 animate-pulse">
        <div className="grid gap-10 lg:grid-cols-2">
          {/* Left Column: Image Skeleton */}
          <div className="aspect-[4/5] w-full skeleton rounded-[2rem] h-[500px]" />
