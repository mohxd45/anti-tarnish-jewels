  ...
  return (
    <div className="mx-auto max-w-3xl px-4 pt-16 pb-32">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-serif text-pink-900 md:text-5xl">
          Privacy Policy
        </h1>
      ...
      <div className="glass-dark rounded-3xl p-8 md:p-12 space-y-12">
        <section>
          <h2 className="text-2xl font-serif text-pink-900 mb-4">1. Information Collection</h2>
        ...
        <section>
          <h2 className="text-2xl font-serif text-pink-900 mb-4">2. Data Usage</h2>
          <p className="text-pink-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-serif text-pink-900 mb-4">3. COD Verification</h2>
          <p className="text-pink-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-serif text-pink-900 mb-4">4. Data Sharing</h2>
          <p className="text-pink-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-serif text-pink-900 mb-4">5. Security</h2>
          <p className="text-pink-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-serif text-pink-900 mb-4">6. Retention</h2>
          <p className="text-pink-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-serif text-pink-900 mb-4">7. Customer Rights</h2>
          <p className="text-pink-700 leading-relaxed">
