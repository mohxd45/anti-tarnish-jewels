...
export const metadata: Metadata = {
  ...
  description: "Read how LONA JEWELS collects, uses, shares, protects and processes personal information.",
};
    ...
    <div className="min-h-screen bg-[#FFF0F5] pb-32">
      <div className="mx-auto max-w-4xl px-4 pt-10 sm:pt-16 pb-12">
        <div className="bg-[#FFF9FB] rounded-[2rem] shadow-[0_8px_24px_rgba(58,36,40,0.04)] border border-[#B8955E]/20 p-8 sm:p-12 text-center mb-10">
          <h1 className="text-3xl sm:text-5xl font-serif text-[#3A2428] mb-6">Privacy Policy</h1>
        </div>
        <div className="bg-[#FFF9FB] rounded-2xl shadow-[0_4px_12px_rgba(58,36,40,0.03)] border border-[#B8955E]/10 p-6 sm:p-10 text-[#3A2428]/80 font-sans space-y-6 text-sm sm:text-base leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-serif text-[#3A2428]">Sharing</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-serif text-[#3A2428]">Security Precautions</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-serif text-[#3A2428]">Data Deletion and Retention</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-serif text-[#3A2428]">Changes to this Privacy Policy</h2>
          ...
          <section className="space-y-3 pt-6 border-t border-[#B8955E]/10">
            <h2 className="text-xl font-serif text-[#3A2428]">Grievance Officer</h2>
            <div className="space-y-1">
              <p><strong>Name of the Office:</strong> Toushim akram</p>
              <p><strong>Designation:</strong> Customer Support Head</p>
              <p><strong>Name and Address of the Company:</strong> Bmst enterprise, 96 H 7 Cossipore Road, Kolkata - 700002</p>
            </div>
            <div className="space-y-1 mt-4">
              <p className="font-medium text-[#3A2428]">Contact us:</p>
              <p><strong>Email:</strong> support@lonajewels.com</p>
              <p><strong>Phone:</strong> 8100558024</p>
