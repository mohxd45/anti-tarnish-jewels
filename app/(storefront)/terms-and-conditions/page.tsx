...
export const metadata: Metadata = {
  title: "Terms & Conditions | LONA JEWELS",
  description: "Read the Terms & Conditions governing use of the LONA JEWELS website and services.",
};
    ...
    <div className="min-h-screen bg-[#FFF0F5] pb-32">
      <div className="mx-auto max-w-4xl px-4 pt-10 sm:pt-16 pb-12">
        <div className="bg-[#FFF9FB] rounded-[2rem] shadow-[0_8px_24px_rgba(58,36,40,0.04)] border border-[#B8955E]/20 p-8 sm:p-12 text-center mb-10">
          <h1 className="text-3xl sm:text-5xl font-serif text-[#3A2428] mb-6">Terms & Conditions</h1>
        </div>
        <div className="bg-[#FFF9FB] rounded-2xl shadow-[0_4px_12px_rgba(58,36,40,0.03)] border border-[#B8955E]/10 p-6 sm:p-10 text-[#3A2428]/80 font-sans space-y-6 text-sm sm:text-base leading-relaxed">
          <ol className="list-decimal pl-5 space-y-4">
            ...
            <li>This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name <strong>https://lonajewels.com/</strong> ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').</li>
            <li>The Platform is owned by <strong>Bmst enterprise</strong> , a company incorporated under the Companies Act, 1956 with its registered office at <strong>96 H 7 Cossipore Road kolkata - 700002</strong> (hereinafter referred to as 'Platform Owner', 'we', 'us', 'our').</li>
            ...
            <li>The use of Platform and/or availing of our Services is subject to the following Terms of Use:
              <ul className="list-disc pl-5 mt-2 space-y-2">
                ...
                <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in and [CLIENT CONFIRMATION REQUIRED].</li>
