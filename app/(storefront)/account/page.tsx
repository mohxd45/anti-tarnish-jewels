      ...
      <div className="mx-auto max-w-7xl px-4 pt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-16">
          ...
          <div className="md:col-span-1 space-y-4">
            <div className="glass-dark p-6 rounded-3xl text-center">
          ...
          <div className="md:col-span-3">
            <div className="glass-dark p-6 md:p-8 rounded-3xl">
              <h2 className="mb-6 font-serif text-2xl text-pink-900">Order History</h2>
              ...
              {orders.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <h3 className="mb-2 font-serif text-xl text-pink-900">No orders yet</h3>
                  <p className="mb-6 text-pink-600">When you place orders, they will appear here.</p>
                  <Link href="/shop" className="btn-primary-gold inline-block">Start Shopping</Link>
                </div>
              ) : (
                <div className="space-y-4">
                  {orders.map(order => (
                    <div key={order.id} className="glass p-4 md:p-6 rounded-2xl flex flex-col sm:flex-row justify-between gap-4">
                      <div>
